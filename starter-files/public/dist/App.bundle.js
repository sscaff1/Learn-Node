...
function handleKeyUp(_ref) {
  ...
  var current = this.querySelector('.' + activeClass);
  var items = this.querySelectorAll('.search__result');
  var next = void 0;
  switch (keyCode) {
    case 13:
      {
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (_ref2) {
      var data = _ref2.data;
